...
class MediaForm(Form):
    ...
    current_episode_id = QuerySelectField(get_label=lambda e: '%.12g' % e.episode_number, allow_blank=True,
                                          blank_text='None')
...
class TagEditForm(Form):
    ...
    colour = StringField('colour', validators=[Regexp('^#[A-Fa-f0-9]{6}$', flags=0, message='Invalid colour hex code.'),
                                               DataRequired()])
